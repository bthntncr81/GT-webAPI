...
{
    Task<IResults> AddSubjectToStudent(long subjectId, DayOfWeekEnum day, string timeSlot);
    Task<IResults> UpdateSubjectForStudent(long subjectId, DayOfWeekEnum day, string timeSlot);
    Task<IResults> DeleteSubjectForStudent(long subjectId, DayOfWeekEnum day, string timeSlot);
