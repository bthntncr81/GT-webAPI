...
public class ClientEmployeeService:IEmployeeAuthService
{
      private readonly IService<EcommerceEmployee> _service;
    ...
    public ClientEmployeeService(IMemoryCache cache,IRefreshTokenService refreshTokenService,  IJwtTokenService<BaseRegisterDTO> tokenService,
        IHttpContextAccessor httpContextAccessor, IService<EcommerceEmployee> service,
         IMapper mapper)
    {
        _mapper = mapper;
        _cache = cache;
    ...
    public async Task<IDataResults<AuthenticatedUserResponseDto>> Register(ClientRegisterRequestDTO registerDto)
    {
        ...
        user = new EcommerceEmployee()
        {
            ...
            UserType = registerDto.UserTypeId,
